...
namespace Math
{
    ...
    struct Vector4
    {
        ...
        Math::Vector3 XYZ()const { return Vector3(x, y, z); }
        ...
        static const Vector4 c_XAxis;
        static const Vector4 c_YAxis;
        static const Vector4 c_ZAxis;
        static const Vector4 c_WAxis;
    };
